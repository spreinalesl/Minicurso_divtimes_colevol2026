       ...
       seqfile = ../concatenated.phylip	* Path to input sequence file (e.g., many alignments in a unique file)
      treefile = ../startingTree.phy	* Path to input tree file including calibration points as node labels	
